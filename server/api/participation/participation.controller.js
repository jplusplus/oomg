...
// Gets a single Participation from the DB
export function show(req, res) {
  return Participation.findById(req.params.id).exec()
...
// Upserts the given Participation in the DB at the specified ID
export function upsert(req, res) {
  if(req.body._id) {
    delete req.body._id;
  }
  return Participation.findOneAndUpdate({_id: req.params.id}, req.body, {upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
